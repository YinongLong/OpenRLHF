...
from openrlhf.datasets import FuserDataset
from openrlhf.datasets.utils import blending_datasets
from openrlhf.models import Actor
from openrlhf.trainer.fuser_trainer import FuserTrainer
...
if __name__ == "__main__":
    ...
    # SFT
    parser.add_argument("--flag_weight", type=float, default=0.5)
    parser.add_argument("--comp_weight", type=float, default=0.5)
    ...
    parser.add_argument("--prefix_key", type=str, default="prefix", help="JSON dataset key")
    parser.add_argument("--flag_key", type=str, default="flag", help="JSON dataset key")
    parser.add_argument("--lead_key", type=str, default="lead", help="JSON dataset key")
    parser.add_argument("--completion_key", type=str, default="completion", help="JSON dataset key")
