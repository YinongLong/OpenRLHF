...
class RewardTrainer(ABC):
    ...
    def concatenated_forward(self, model, chosen_ids, c_mask, reject_ids, r_mask):
        ...
        eos_logits = model(input_ids, attention_mask=att_masks)
        chosen_rewards = eos_logits[: chosen_ids.shape[0]]
        rejected_rewards = eos_logits[chosen_ids.shape[0] :]
