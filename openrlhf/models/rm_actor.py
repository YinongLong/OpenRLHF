...
class RMActor(nn.Module):
    """
    Base class for Reward models in reinforcement learning.
    ...
    def forward(
        ...
        if self.packing_samples:
            sequences, position_ids, _, ring_attn_pad_len, indices = unpad_and_slice_tensor(
        ...
        # (bsz, seq_len, 1) -> (bsz, seq_len) -> (bsz, )
        eos_logits = output["logits"].squeeze(-1)[:, -1]
        return eos_logits
